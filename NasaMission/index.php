...
$rover1 = new RoverModel($area, $inputs['coordinates'], $inputs['direction']);
...
$input = '3 3 E';
$inputs = Input::coordinatesAndDirectionFromString($input);
$rover2 = new RoverModel($area, $inputs['coordinates'], $inputs['direction']);
...
echo $rover1->getPosition();
echo php_sapi_name() == "cli" ? "\r\n" : '<br />';
echo $rover2->getPosition();
echo "\r\n";